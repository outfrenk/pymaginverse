...
from geomagnetic_field_inversions.tools.field_inversion_onestep import FieldInversion_notime
...
def test_model(maxdegree, types, max_iter, latp=15, lonp=15, t_index=-1):
    ...
    # use class
    testclass = FieldInversion_notime(time=time, maxdegree=maxdegree,
                                      geodetic=False)
