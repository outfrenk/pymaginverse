...
while ($a < 11)
    ...
    ~/linux/archfield/progdi/Onestep < InPtEmP
    ~/linux/archfield/progdi/Misfit < InPtEmP
#    ~/linux/temp/code/Oneex < InPtEmP
#    ~/linux/temp/code/Misfitex < InPtEmP
    cat normres >> aall$i$j$k$l
    \rm modintd
    cp newmod modintd
    cp newmod anew$i$j$k$l.it$a
@ aa = $a
@ a = $aa + 1
end
    end
